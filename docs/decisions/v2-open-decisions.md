...
| D-106 | x402 payments — scope, non-goals, gate                                                                                     | Build gate satisfied (C-wave landed); Phase 17 built the six-service seller catalog + dual-rail paywall with tests and roadmap rows (PR #61 foundation + PR #62 services + PR #63 docs/ledger, all merged); open questions (b)/(c) resolved 2026-09-19 — OpenAPI publication PR still open; go-live counsel-gated (D-012)                                                                                                                                                                                                                              | High (facts)                                                | Counsel (D-012 seller-revenue posture gates go-live)                                                     |
...
- **(b) List more services beyond the analyst brief? — YES.** Six services
  ...
  publication + catalog↔spec parity test still land in a separate PR.
