...
> docs/ledger: PR #63. OpenAPI publication + parity test still land in a
> separate PR.
...
| 17 — Circle Agent Marketplace + Agent-Native Services       | 🟢 P2 | MP-001 … MP-011 | 🟡 (task 073; foundation #61 + services #62 + docs/ledger #63 landed; OpenAPI publication PR still open; go-live counsel-gated) |
