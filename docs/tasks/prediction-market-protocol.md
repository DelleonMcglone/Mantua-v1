...
1. **M-01 (MEDIUM) — owner written acceptance pending.** From 045's
   ...
   **not** re-sign the ship gate. _Phase 7 / task 053 shipped the alerting half: `frozen_not_final` pages when a FROZEN market's game is not final for > 5 min (`docs/ops/monitoring.md`); the on-chain registry read remains a follow-up._ L-01/L-02/I-01/I-02 remain documented and
   open; none block.
