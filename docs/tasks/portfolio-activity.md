...
>
> Snapshot: 2026-09-12 (post-062) · **6 ✅ · 13 🟡 · 2 ⬜**.
...
| PF-002 | §2 Positions (liquidity) — per pool deposited, value, fees, P&L, share                                         | 🟡     | LP positions + uncollected fees shipped; cost basis / P&L / share — lane 063                 |
| PF-003 | §3 Market positions — event, market, side, entry, current, value, unrealized P&L, potential payout, status     | 🟡     | Marked positions with entry + P&L shipped; potential payout + event grouping — lane 063      |
...
| PF-007 | §7 Earnings — LP earnings plus other realized earnings                                                         | 🟡     | Uncollected LP fees shipped; realized earnings — lane 063                                    |
...
| PF-012 | Settled-position history with realized P&L                                                                     | 🟡     | Agent-only (`computePerformance`); user route + UI — lanes 063 / 065                         |
...
| PF-018 | Verification links without chain branding                                                                      | 🟡     | `TxRow` is neutral; three leaks + no sweep test — lane 064                                   |
| PF-019 | Chronological card/timeline view                                                                               | ⬜     | Lane 064 (`GET /api/activity` ready)                                                         |
