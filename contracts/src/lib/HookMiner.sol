...
/**
 * @notice Vendored from Uniswap v4-periphery, commit
 *         eeb3eff28dd5f5f17aa94180fa3610ff59b0e1c8 (path: src/utils/HookMiner.sol).
 *         Identical source — only this header comment is added.
 *
 *         Why vendored: HookMiner was removed from later v4-periphery commits,
 *         so a `forge install` of HEAD doesn't include it. Pinning the
 *         monorepo's v4-periphery to an older commit just to keep one library
