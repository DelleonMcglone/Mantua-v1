...
import { opsInstitutionsRouter } from "./routes/ops-institutions.ts";
import { opsInstitutionsManageRouter } from "./routes/ops-institutions-manage.ts";
import { institutionRouter } from "./routes/institution.ts";
import { institutionMembersRouter } from "./routes/institution-members.ts";
import { institutionMembersPatchRouter } from "./routes/institution-members-patch.ts";
import { institutionDestinationsRouter } from "./routes/institution-destinations.ts";
import { institutionDestinationsVerifyRouter } from "./routes/institution-destinations-verify.ts";
import { institutionWithdrawalsRouter } from "./routes/institution-withdrawals.ts";
import { institutionWithdrawalsDecideRouter } from "./routes/institution-withdrawals-decide.ts";
import { institutionReportsRouter } from "./routes/institution-reports.ts";
...
// Phase 17 — the UNPAID OpenAPI publication surface (listing prerequisite).
import { x402OpenApiRouter } from "./routes/x402-openapi.ts";
...
app.use(institutionMembersRouter);
app.use(institutionMembersPatchRouter);
app.use(institutionDestinationsRouter);
app.use(institutionDestinationsVerifyRouter);
app.use(institutionWithdrawalsRouter);
app.use(institutionWithdrawalsDecideRouter);
app.use(institutionReportsRouter);
...
// Phase 17 — unpaid OpenAPI documents and services index (no paywall).
app.use(x402OpenApiRouter);
